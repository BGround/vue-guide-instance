...
-->
<template>
  <label class="qwui-radio" :class="{
      'is-checked':model === label,
      'is-disabled':disabled,
      'is-bordered': border
    }">
    <span class="qwui-radio-input" :class="[{
      'is-checked':model === label,
      'is-disabled':disabled
    }]">
      <span class="qwui-radio-inner"></span>
      <input type="radio" class="qwui-radio-original"
        :value="label"
        :disabled="disabled"
        v-model="model"
        @change="handleChange">
    </span>
    <span class="qwui-radio-label">
      <slot></slot>
    </span>
  </label>
</template>
