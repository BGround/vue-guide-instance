    ...
    <div class="qwui-pick_person">
      ...
      <div class="qwui-main_content">
        ...
        <div class="qwui-content_height">
          ...
          <!--  选择职位组件  -->
          <position
                    :defaultPostList="defaultPostList"
                    :params="params"
...
<script>
  ...
  import position from './item/positionMust.vue'
...
/*        if(this.searchMore.pageConfig.pageData && this.searchMore.pageConfig.pageData.length > 0) {
      ...
      updateValue:function (value) {
       // console.log(this.isPosition)
        ...
        //     self.searchMore.url = '/post/postAction!getPositionList.action'
      ...
      searchFinished:function (val) {
        console.log(val)
        this.defaultPostList = val.pageData;

      },
      //选择完成，点击确定
      chooseDone:function () {
        this.$emit('chooseDone',this.specialPosition)
      },
      //清空已选
      clearAll(){
