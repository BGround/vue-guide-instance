  ...
  <div v-show="personCountShow">
    <div class="qwui-person_count">
      ...
      <span>已选
          ...
          <span v-if="showType.tag">
            <span class="qwui-count_num">{{ tagCount }}</span>
            标签，
          </span>
      ...
      <span v-if="deptCount || personCount || tagCount" class="clearSelect" @click="deleteAll">清空已选</span>
    </div>
    <!--选人展示框-->
    <div v-if="deptCount || personCount || tagCount" class="qwui-main_result">
      <div class="qwui-selected_input">
        ...
        <div class="qwui-dept_selected" v-for="(item,index) in defaultDepts">
          ...
          {{ item.nodeName || item.deptName || item.departmentName}}
  ...
  export default {
    ...
    methods:{
      ...
      deleteAll(){
        ...
        this.defaultTags.splice(0,this.defaultTags.length);
    ...
    computed:{
      ...
      tagCount(){
        return this.defaultTags.length;
      },
      personCount(){
