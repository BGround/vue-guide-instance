<template>
  <div class="clearfix"
    ...
    <div class="qwui-admin_list" v-show="!batchShow">
...
<script>
import { getNewAdminList } from '../api/getData'
import adminList from '../checkList/subAdminList.vue'
