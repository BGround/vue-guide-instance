...
export default {
  methods: {
    ...
    _exportReport(params) {
      return axios.post(_.baseURL + '/report/reportAction!createReportTask.action', params).then(function (result) {
        if (result.code == '0') {
      ...
      //     method: 'post',
      //     baseURL: _.baseURL,
      //     url: '/report/reportAction!createReportTask.action',
      //     params: params,
