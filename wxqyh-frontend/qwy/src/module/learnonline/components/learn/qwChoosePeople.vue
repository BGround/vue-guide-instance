<template>
  ...
  >
    ...
    <div class="qwui-form_item_content">
      ...
      <div class="qwui-form_item_error_tip" v-if="showValidate">请选择考试对象</div>
      <!--选人统计-->
      ...
      <div class="content_tip">
        <span class="greyColor"><slot name="generalUser"></slot></span>
        <span class="orangeColor" @click="$goBuyVip"><slot name="vipUser"></slot></span>
      </div>
      <pick-person
        :show="show"
