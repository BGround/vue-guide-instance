  ...
  <div class="operating-auth">
    ...
    <div class="qwui-nav_wrap">
      ...
      <div class="wrap__left">
        ...
        <qwuiButton type="button" @click="handleClickCarModelManagementBtn">&nbsp;星途车型管理&nbsp;</qwuiButton>
      </div>
    ...
    <div class="qwui-title_wrap">
      <div class="qwui-title">星途车型经营权限管理</div>
    </div>
    ...
    <el-dialog
      ...
      <div class="dialog__content">
        <importExcel v-if="isVisibleDialog" reportType="DEALER_CELEBRITY_MODELES"></importExcel>
      </div>
      <div slot="footer">
      </div>
    ...
    <el-dialog
            @close="handleCloseDialog"
            :title="currentDetailId?'编辑':'新增'"
            :visible.sync="isVisibleEditDialog"
            width="500px">
      <div class="dialog__content">
        <operatingAuthorityEdit @submit="handleSubmit" :detailId="currentDetailId" :dealerId="currentDealerId"></operatingAuthorityEdit>
      </div>
      <div slot="footer">
      </div>
    </el-dialog>
    ...
    export default {
        ...
        methods: {
            ...
            handleClickRemoveBatchBtn(){
                ...
                operatingAuthorityApi.ajaxDeleteDealerCelebrityModels(params).then((data)=>{
                    if(data){
                        this.searchCarModel();
                    }
                })
            ...
            handleClickRemoveBtn(ids){
                operatingAuthorityApi.ajaxDeleteDealerCelebrityModels({'ids':ids}).then((data)=>{
                    if(data){
                        this.searchCarModel();
                    }
                })
            ...
            handleClickEditBtn(item){
                ...
                this.currentDealerId = item.dealerId;
                this.isVisibleEditDialog = true;
            },
            ...
            handleClickExportBtn(){
                const form = {
                    ...
                    'reportType': 'dealer_celebrity_models', //导出类型
                }
                this._exportReport(form)
            },
