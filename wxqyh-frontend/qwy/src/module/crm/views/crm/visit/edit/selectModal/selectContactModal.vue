...
<script>
  ...
  import { visitContactList } from "crm/api/visit";
  ...
  export default {
    ...
    methods: {
      init() {
        console.log(this.defaultCheckedList,JSON.stringify(this.defaultCheckedList) , JSON.stringify(this.checkedList))
      ...
      getList() {
        ...
        visitContactList(this.params).then(res => {
          if (res.code == "0") {
      ...
      getSearchList() {
        ...
        visitContactList(this.searchParams).then(res => {
          // console.log(res);
          if (res.code == "0") {
