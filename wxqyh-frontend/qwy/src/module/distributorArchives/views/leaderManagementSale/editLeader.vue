      ...
      <div class="form">
        ...
        <div v-if="id" class="form__item">
          ...
          <div class="form__item__value">
            ...
            <el-input size="small" v-model="serviceErp" :disabled="true" placeholder="销售ERP号"></el-input>
        ...
        <div v-if="id" class="form__item">
          ...
          <div class="form__item__value">
            ...
            <el-input size="small" v-model="serviceStationName" :disabled="true" placeholder="经销商简称"></el-input>
        ...
        <div class="form__item">
          ...
          <div class="form__item__value" v-if="serviceErp">
            ...
            <leaderSelector :id="id" :serviceErp="serviceErp" v-model="mobile" @confirm="handleConfirmUser"></leaderSelector>
            <div class="result" v-if="mobile">
...
<script>
    ...
    import {addAndUpdateSearchSale,  saleAdminPortalAction} from "../../api/getData";
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmit(){
                ...
                addAndUpdateSearchSale(params).then((data)=>{
            ...
            initData(){
                saleAdminPortalAction({id:this.id}).then((data)=>{
                    ...
                    this.serviceStationName = data && data.dealerShortName ? data.dealerShortName: '';
