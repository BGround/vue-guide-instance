...
<script>
  import Mask_fix from 'vpCommon/part/mask_fix';
  import qwui_textarea from 'vpCommon/input/inputTextarea';
  import 'vpModule/assets/js/flipsnap.js'
  import {uploadImages,wx_chooseImage,qw_uploadImages} from 'vpModule/utils/uploadImages';
  import {smile_array,codeToWord,imgToCode} from 'vpModule/utils/emoji';
