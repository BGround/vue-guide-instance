...
<script>
  import groupTemp from 'vpCommon/base/userOrDeptSelect/group_item_temp';
  import userTemp from 'vpCommon/base/userOrDeptSelect/user_item_temp';
  import deptTemp from 'vpCommon/base/userOrDeptSelect/dept_item_temp';
  import userDept from 'vpCommon/base/userOrDeptSelect/user_dept_temp';
  import resultTemp from 'vpCommon/base/userOrDeptSelect/result_item_temp';
  export default {
...
<style>
  ...
  .qwui-userOrDept_select_scroll::-webkit-scrollbar{
    width:0px;
    height:6px;
  }
