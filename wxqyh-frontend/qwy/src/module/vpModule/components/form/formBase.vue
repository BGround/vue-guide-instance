<template>
	<div class="form-content form-bg">
		<div class="form-group" v-for="field in combineList" :key="field.id"  v-show="!addPage || field.show">
      <!--v-show="field.show"-->
...
<script>
	...
	import {setReadonlyEdit} from 'vpModule/js/form/getData'
	import {getHistory} from 'vpModule/api/form/list'
	export default {
		name: 'formBase',
		components: {
			TextField,
...
<style>
  ...
  .form-title-read span.form-title-title{
    overflow: hidden;
    display: -webkit-box;
    -webkit-box-orient: vertical;
    -webkit-line-clamp: 1;
  }
  .form-title-read input.form-title-edit{
    width: 100%;
    height: 27px;
    line-height: 1;
    font-size: 18px;
  ...
  .form-title-read .font-count-position {
