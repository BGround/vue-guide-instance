  ...
  export default {
    ...
    methods: {
      ...
      getData(){
        ...
        var url = this.field.ref_url+`?wxUserId=${dataBase.config.wxUserId}&corpId=${wxqyhConfig.orgConfigInfo.corpId}&id=${this.field._id}&page=${this.page}&pageSize=${this.pageSize}`;
        var param = {
          url,
          params,
        }
