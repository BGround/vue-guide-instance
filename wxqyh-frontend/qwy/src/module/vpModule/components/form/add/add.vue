  ...
  <div class="title-wrap">
    <div style="height: 900px">
      <div class="title-color">
        <div class="wrap-head">
          ...
          <div class="form-title-operate">
            <div class="form-title-btn" @click="submited">提交</div>
            <div class="form-title-btn form-title-cancel">取消</div>
          </div>
          <div class="form-title-read" :class="{'form-title-edit':isUpdateTitle}">
            <input class="form-title-edit" @blur="saveFormTitle($event)" v-model="formTitle" maxlength="100" :disabled="!isUpdateTitle">
            <span class="font-count font-count-position" :class="{colorRed:formTitle.length == 100}" v-if="isUpdateTitle">{{formTitle.length}}/100<span class="icon-title-edit"></span></span>
          </div>
        </div>
      </div>
      ...
      <div class="content-wrap">
        <div class="form-bg">
            <!--表单截止时间-->
            <div class="form-title-msg" v-if="formStop">
        ...
        <formBase v-show="isShowFields && showFormBase" @change="fieldChange"/>
        <!--附件列表-->
        ...
        <div class="uploadFile" v-if="isFile||isPic">
          <!--上传附件-->
          <div class="fl upload-file-mr">
...
<script>
  ...
  import crm_info from '../base/crm_info';
	...
	import {setFieldShowRead,getFrom, render_field,getOldGivenList,saveFormData,removeFormData,getFormData,setFieldShowHide,loadScript, getMember} from 'vpModule/js/form/getData'
	import Vue from 'vue'
