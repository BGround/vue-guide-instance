      ...
      <div class="selectBoxContent">
        ...
        <div v-if="FlowAuditUser.length">
          <user_selected_group
            ...
            v-for="(item,index) in FlowAuditUser" :key="index"
        ...
        <user_selected_group
          ...
          v-for="(item,index) in appointNodeAndUserVOList" :key="index"
...
<script>
  ...
  import chooseNextNode from './chooseNextNode'
  import {qwui_button, button_group} from 'vpCommon/base/button'
