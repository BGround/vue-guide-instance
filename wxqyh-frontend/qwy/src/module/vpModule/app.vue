...
<script>
import dialog_mask from 'vpCommon/base/dialog_mask';//弹窗组件
import loading from 'vpCommon/base/loading';//加载中、操作成功提示组件（删除成功、提交成功）
//import exit from 'vpCommon/base/exit';//首页退出提示
import user_choose from 'vpCommon/base/user_or_dept_select.vue' //js导入
import select_form from './components/form/base/select_form.vue'
...
<style>
  ...
  .dp-item.dp-right,.dp-item.vux-datetime-clear{
