...
export default {
    ...
    data() {
        return {
            ...
            // 选人
            show:false,
            defaultDepts:this.objVal["markSetting[0].deptIds"],
            defaultUsers:this.objVal["markSetting[0].targetIds"],
    ...
    watch:{
      'objVal': {
        handler: function(val) {
            ...
            this.defaultDepts.push(...val["markSetting[0].deptIds"]);
            this.defaultUsers.push(...val["markSetting[0].targetIds"]);
    ...
    methods:{
      ...
      deleteDept:function (index) {
        ...
        this.EVENT_BUS.$emit('on-set-form-data', {
          key: this.keyName,
            value: {
              "markSetting[0].deptIds": this.defaultDepts,
              "markSetting[0].targetIds": this.defaultUsers,
      ...
      chooseDone:function (dept,tag,user,post) {
        ...
        this.EVENT_BUS.$emit('on-set-form-data',{
            key: this.keyName,
            value: {
                "markSetting[0].deptIds": dept,
                "markSetting[0].targetIds": user,
