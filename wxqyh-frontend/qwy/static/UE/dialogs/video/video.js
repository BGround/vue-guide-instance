...
(function(){
    ...
    function addOkListener(){
        ...
        dialog.onok = function(){
            ...
            // var vipUrl= qwyURL + '/qiweipublicity/companysrv/vip/vip_index.jsp';
            // //var vipUrl='http://wbg.do1.com.cn/ask/pingtaifeiyong/2015/0801/377.html';
            // var vipHtml='该功能仅限尊享版使用';
            // var isQuDao = window.top.isQuDao();
            // if(!isQuDao){
            //     vipHtml = vipHtml + '，<a href="'+vipUrl+'" target="_blank">马上升级 ></a>';
            // }
            // var isVip = window.top.isVipSilver(window.top.interfaceCode.INTERFACE_CODE_DYNAMIC);
            // //if(!$("#isvip",window.top.document).is(":hidden") &&  $("#isvip",window.top.document).attr("class")=="novip"){
            // if(!isVip){
            //     window.top._alert("提示",vipHtml)
            //     return;
            // }
