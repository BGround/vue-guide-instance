        ...
        dialog.onok = function () {
            ...
            switch (id) {
                ...
                case 'upload':
                    ...
                    var $frame = window_top.find('#personFrame').contents().find('#frame');
                    var $frame2 = window_top.find('#personFrame').contents().find('#topicFrame');
                    var $editorFleMediasDivObj;
                    if($frame.length>0){
                        $editorFleMediasDivObj=window_top.find('#personFrame').contents().find('#frame').contents().find('#editorFileMedias_div');
                    }else if($frame2.length>0){
                        $editorFleMediasDivObj=window_top.find('#personFrame').contents().find('#topicFrame').contents().find('#editorFileMedias_div');
                    }else{
                        $editorFleMediasDivObj=window_top.find('#personFrame').contents().find('#editorFileMedias_div');
                    }
                    for(var i=0;i<list.length;i++){
                        var fileVO=list[i];
                        $editorFleMediasDivObj.append("<input name='editorFileMedias' type='text' id='"+fileVO.fileId+"' value='"+fileVO.fileId+"'/>");
                    }
                    break;
                case 'online':
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                accept: {
                    ...
                    mimeTypes: 'image/jpeg,image/jpg,image/png,image/gif' //image/jpeg,image/jpg,image/png,image/gif  image/*
                },
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        _this.imageList[$file.index()]=json;// lishengtao 按选择好的列表文件顺序储存
