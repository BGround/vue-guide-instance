...
module.exports = {
  build: {
    ...
    assetsRoot: path.resolve(__dirname, '../../../wxqyh/src/main/webapp/login'),
    assetsSubDirectory: 'static',// 编译输出的二级目录
    assetsPublicPath: '/authserver/login/',// 编译发布的根目录，可配置为资源服务器域名或 CDN 域名
    /*什么是Source map
  ...
  dev: {
    ...
    port: 8088,
    url:'/module/login.html',//自动打开浏览器url
    autoOpenBrowser: true,//用于判断是否要自动打开浏览器的布尔变量
    assetsSubDirectory: 'static',// 编译输出的二级目录
    assetsSubVLoginDirectory: 'login/static',// 编译输出的二级目录
