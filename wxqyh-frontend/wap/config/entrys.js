...
let entrys = {
  devEntrys: [
    // 'cloudOffice', /*云办公*/
    'corporateCulture', /*企微云文化*/
    // 'crm', /*移动CRM*/
    // 'demo', /*文档手册 demo*/
    // 'diary', /*工作日志*/
    'dynamic', /*登录*/
    // 'enterpriseInfo', /*企业信息查询*/
    // 'error', /*错误提示*/
    // 'express', /*拿快递*/
    // 'flowDemo', /*流程测试*/
    // 'form', /*表单流程*/
    ...
    // 'moveapprove', /*审批请示*/
    // 'others', /*临时小需求*/
    // 'partyConstruction', /*智慧党建*/
    // 'publicPhone', /*公费电话客户列表*/
    // 'reimbursement', /*移动报销*/
    // 'systemDataSearch', /*企微研发数据查询*/
    'taskAssignment', /*任务分派*/
    // 'waittask', /*待办事项*/
    'channelManagement',
    // 'postManagement',
...
function replaceEntrys() {
  ...
  if (hasEntrysFile || fs.existsSync(selfUseEntrysFile)) {
    try {
      let userEntrys = hasEntrysFile ? require(entrysFile) : require(selfUseEntrysFile);
      entrys.devEntrys = userEntrys.devEntrys || entrys.devEntrys;
      console.log('已加载自定义配置文件：', hasEntrysFile ? entrysFile : selfUseEntrysFile);
    } catch (err) {
      console.error(err);
      return false;
    }
