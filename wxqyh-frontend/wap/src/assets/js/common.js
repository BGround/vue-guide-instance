...
;(function(w){
      ...
      if(!isMobile){
        ...
        wx.getLocation({
          ...
          success: function (res) {
            ...
            //定位校准
            qq.maps.convertor.translate(latLng, 1, function(resData) {
     ...
     * 媒体文件预览
     */
    wxqyh_previewFile:function (id,url,fileName,fileExt) {
      debugger
     ...
     * 新闻明细附件扩展-媒体文件预览
     */
    wxqyh_previewFile:function (id,url,fileName,fileExt,isPointToPoint,erpNos) {
      debugger
      var href = _.fileDownURL + _.downFileURL + encodeURIComponent(url) + "&fileFileName=" + encodeURIComponent(fileName) + "&isPointToPoint=" + encodeURIComponent(isPointToPoint) + "&erpNos=" + encodeURIComponent(erpNos) + "&fileId=" + encodeURIComponent(id);
      if(fileExt == 'PDF'){
        href = _.baseURL+'/jsp/wap/learnonline/generic/web/viewer.html?url='+href;
      }else if(/DOC|DOCX|PPT|PPTX|XLS|XLSX|TXT|XML/.test(fileExt) && _.is_use_yongzhong ){
        href = _.yongzhong_url + href;
