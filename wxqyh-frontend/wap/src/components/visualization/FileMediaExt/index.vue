    ...
    <ul class="qwui-file_list">
      ...
      >
        ...
        <p class="qwui-file_function">
          ...
          ></a>
          <a href="javascript: void(0)" v-show="!(file.filename.includes('xls') || file.filename.includes('xlsx') || file.filename.includes('csv'))"
...
export default {
  ...
  methods: {
    ...
    filePreview (file) {
      _.wxqyh_previewFile(file.id, file.url, file.filename, file.ext, file.isPointToPoint, file.erpNos);
    },
    fileDownload (file) {
