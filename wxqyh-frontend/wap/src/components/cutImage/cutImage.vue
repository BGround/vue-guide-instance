<template>
  <div class="qwui-cutImg"
    ...
    <div class="qwui-cutImg_box">
      <div class="qwui-cutImg_box-canvas"
           v-show="!loading"
           :style="{
					'width': trueWidth + 'px',
    ...
    <div class="cropper-crop-box"
      ...
      <!--截剪尺寸提示-->
      <span class="qwui-cutImg_info" v-if="info">
      ...
      <div class="qwui-cutImg_grid" v-if="grid">
        <span class="span" :class="{'bottom':n>6}" v-for="n in 9" :key="n"></span>
      </div>
    </div>

    <!--按钮操作区域-->
    <div class="qwui-cutImg_btn">

      <span class="qwui-cutImg_btn_text">
        <span class="qwui-cutImg_icon" @click="close">
        <i class="close"></i>
        </span>
      </span>
      <span class="qwui-cutImg_btn_text">
        <span class="qwui-cutImg_icon" @click="refresh">
          <i class="refresh"></i>
        </span>
      </span>
      <span class="qwui-cutImg_btn_text">
        <span class="qwui-cutImg_icon" @click="rotateRight">
          <i class="rotateRight"></i>
        </span>
      </span>
      <span class="qwui-cutImg_btn_text">
        <span class="qwui-cutImg_icon" @click="finish">
          <i class="finish"></i>
        </span>
      </span>
    </div>
      ...
      if (!HTMLCanvasElement.prototype.toBlob) {
        Object.defineProperty(HTMLCanvasElement.prototype, "toBlob", {
          value: function(callback, type, quality) {
            ...
            callback(new Blob([arr], { type: self.type || "image/png" }));
          }
        });
      }
...
<style scoped>
  ...
  .qwui-cutImg_grid .span.bottom:after{
    border-bottom: none;
  }
  .qwui-cutImg_grid .span:before:nth-child(3n){
    border-right: none;
  }
  .close{
    background: url("../../assets/images/icon_cut_close.png") no-repeat 100%;
    background-size: 100% 100%;
  }
  .refresh{
    background: url("../../assets/images/icon_cut_refresh.png") no-repeat 100%;
    background-size: 100% 100%;
  }
  .rotateRight{
    background: url("../../assets/images/icon_cut_rotateRight.png") no-repeat 100%;
    background-size: 100% 100%;
  }
  .finish{
    background: url("../../assets/images/icon_cut_finish.png") no-repeat 100%;
    background-size: 100% 100%;
  }
