<template>
	<div class="field-content">
		<div class="field-bcolor clearfix choice-field" :class="{'text-field-help':field.help,'readOnly':field.readonly || field.disabled}">
			...
			>
				<i :class="{active:fieldVal.indexOf(choice._id)!=-1,noClick:selectQuota[choice._id]&&selectQuota[choice._id].selectedNum>=choice.quota||field.disabled,'choice-top':isChildField}"></i>{{choice.value}}
