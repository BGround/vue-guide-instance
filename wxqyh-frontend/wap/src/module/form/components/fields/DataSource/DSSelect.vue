...
<script>
  export default {
    ...
    methods:{
      ...
      setValue(){
        var value = this.selectValue[this.mainField] == '请选择'&&!this.selectValue[this.id]?undefined:JSON.stringify(this.selectValue)
        this.$emit('sourceData',value?[value]:value)
      },
    }
