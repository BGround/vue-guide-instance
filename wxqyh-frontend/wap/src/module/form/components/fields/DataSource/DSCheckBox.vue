  ...
  <div class="field-content">
    <div class="field-bcolor clearfix choice-field">
      <div class="choice-field-item checkbox-field-item"
           ...
           :class="{row1:1==field.line_row,row2:2==field.line_row,row3:3==field.line_row,'choice-field-click':!field.disabled}">
        <i :class="{active:fieldKey.indexOf(choice[IdShowKey])!= -1,noClick:field.disabled}"></i>{{choice[MainFieldKey]}} <span v-if="idShow">({{choice[IdShowKey]}})</span>
      </div>
    </div>
  </div>
</template>
