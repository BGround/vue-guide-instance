const INITDATA = [
  {
    ...
    "status": "",
    "typeCode": "momo",
    "typeName": "默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别默默个人类别1"
  },
  {
    "childrenNum": 0,
    "createTime": {
...
export function getData(lock_roll) {
...
export function getNextItem(id) {
  return new Promise(resolve => {
    setTimeout(() => {
      if(!id) {
        resolve(NEXTITEMDATA);
      }
      resolve(NEXTITEMDATA2)
    }, 2000);
  });
}
