<template>
  <div class="qwui-lean_search_course" :class="{'is_show_tab': isShowTab}" @click.capture="banClick">
    <!--tab选项卡-->
    <header class="qwui-menu_tab_fixed fixed_set_top" v-show="isShowTab">
      <menu-tab-two
            ...
            >
              <div class="item_section" slot="section">
                <div class="item_section_people clearfix">
                  ...
                  {{item.saleLearnersNum + $t('i18n.hasStudy')}}
