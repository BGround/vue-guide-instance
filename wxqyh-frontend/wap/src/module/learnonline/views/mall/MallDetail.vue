<template lang="html">
  <div class="wrap qwui-mallDetail" :style="{ height: winHeight + 'px'}">
    <div class="wrap_inner" @scroll="scrollList" ref="scroll_wrap">
      ...
      <div v-if="selectData.index == 0" key="introduce" class="introduce_wrap">
        <div class="course_info mall_section">
          ...
          <p v-if="subject && subject.totalLearnerNum>=0" class="learn_num">{{subject && subject.saleLearnersNum}}{{$t('i18n.hasStudy')}}</p>
    ...
    <!-- 想学按钮 , 为了适配iphoneX,在按钮外部嵌套一个div-->
    <div class="wantLearn_wrap qwui-nav_footer_fix"
        v-if="!isFree"
    >
      <div
        class="wantLearn_btn"
          ...
          if (courseFlow <= totalFlow) {
            ...
            getVideoUrl({
              ...
              this.player = new TcPlayer('preview_video', {
                ...
                "x5_type": 'h5',//开启同层播放，防止安卓的评论弹框被视频挡住
