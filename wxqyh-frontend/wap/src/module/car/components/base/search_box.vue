<template>
  <div class="qwui-search_wrap"  :class="{'qwui-search_mask': setTopMask, 'qwui-no_mask':searchinput.ridMask}">
    <div class="qwui-search_bar">
      ...
      <!--排序显示-->
      <div v-if="searchinput.sort && searchinput.sort.show" @click.stop.prevent="sort=!sort" class="search_sort relative" style="box-sizing: initial;-webkit-box-sizing:initial;">
        <div v-if="sort"  class="sort_type  none" style="top: 27px; left: -25px;">
          <span class="search_Popsan" style=""></span>
          <ul  class="sort_type_list" style="position: relative;top:6px;left: -5px;">
            <li v-for="(item, key) in searchinput.sort.option"
                :key="item.value"
                class="fz13" :class='{bg_active:isactive[key]}'
                @click.stop.prevent="thisSort(item, key)"
                >
                {{item.name}}
                <i :class="{arrow_up:item.arrowup,arrow_down:item.arrowdown}"></i>
            </li>
          </ul>
        </div>
      </div>
...
<style type="text/css">
  ...
  .qwui-search_text .icon_search {
    ...
    background: url(~assets/images/car/ic_search.png) no-repeat;
  ...
  .qwui-search_inner .icon_search {
    ...
    background: url(~assets/images/car/ic_search.png) right no-repeat;
    background-size: 14px;
    cursor: pointer;
  ...
  .qwui-search_inner .qwui-icon_del {
    ...
    padding: 0;
    border:none;
    background: url(~assets/images/car/ic_del.png) no-repeat;
    background-size: 14px;
  }
  ...
  .qwui-search_hanber{
    ...
    margin:4px 5px 0 0;
    background: url(~assets/images/car/qwui-content.png) 10px -16px no-repeat;
  ...
  .search_sort {
    ...
    background: url(~assets/images/car/ic_sort.png) right no-repeat;
  ...
  .arrow_up {
    background: url(~assets/images/car/arrow_up.png) no-repeat;
  ...
  .arrow_down {
    background: url(~assets/images/car/arrow_down.png) no-repeat;
    background-size: 11px;
  }
  .arrow_up, .arrow_down {
    width: 12px;
