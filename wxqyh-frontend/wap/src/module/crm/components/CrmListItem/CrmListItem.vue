/**
  ...
  *              mid: [  // 中间栏配置
  *                  {
  *                      midShowTab: false , // 中间栏项是否显示标签
  *                      midTabClass: '', // 中间栏项标签类名 tab_orange、tab_blue
  *                      midTabName: '' , // 中间栏项标签状态名称
  *                      title: '客户类别：',  // 中间栏项名称
            ...
            <div class="list_item_mid">
                <div class="flexMid"
                    ...
                    <div class="mid_inner"
                        ...
                        <span v-if="item.midTabName" class="contract-status" :class="item.midTabClass">{{item.midTabName}}</span>
                    ...
                    <div class="flexRight" v-if="item.midRight && item.midRight.isShow">
                        <span :style="{color: item.midRight.titleColor? item.midRight.titleColor : 'inherit'}">{{item.midRight.titleRight}}</span>
                        <span :style="{color: item.midRight.valueColor? item.midRight.valueColor : 'inherit'}">{{item.midRight.valueRight}}</span>
                    </div>
                </div>
            </div>
