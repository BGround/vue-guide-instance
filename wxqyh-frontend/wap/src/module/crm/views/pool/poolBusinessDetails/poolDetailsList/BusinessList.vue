...
<script>
  ...
  import {getPoolBusinessDetailsList} from '../../../../api/pool/getData.js';
  export default {
    components:{
      crm_list,
      loadMore,
    ...
    methods:{
      ...
      getList:function(){
        ...
        getPoolBusinessDetailsList(opt,(result) => {
      ...
      loadMore:function(el){
        ...
        this.lock_roll = this.$route.name == 'poolBusinessList'? true: false;
