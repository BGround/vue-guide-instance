...
<script>
  ...
  import {getPoolVisitDetailsList} from '../../../../api/pool/getData.js';
  export default {
    components:{
      crm_list,
      loadMore,
    ...
    methods:{
      ...
      getList:function(){
        ...
        getPoolVisitDetailsList(opt,(result) => {
              ...
              let obj = {
                ...
                bottom: {
                  ...
                  data: [
                    {
                      title: '更新时间：',  // 底部栏项名称
                      value: result.pageData[i].createTime  // 底部栏项值
                    }
                  ]
                }
              }
      ...
      loadMore:function(el){
        ...
        this.lock_roll = this.$route.name == 'poolVisitList'? true: false;
      ...
      getListId:function(id){
        this.$router.push({path:'/PoolDetails/poolVisitContent',query:{id:id}});
      },
