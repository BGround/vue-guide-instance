  ...
  <div class="wrap goalDetail" @click="removeMask">
    ...
    <div class="crm_goal_container">
      ...
      <div class="crm_goal_dataShowPanel">
        ...
        <div>
          <x-chart :id="chart" :option="highChartsOption" ref="hightChart" v-show="hasHighChartsOption"></x-chart>
...
<script>
  ...
  import {getfilter,getGoalInfo} from "../../../api/dataBoard/getData.js";
  import XChart from '../../../components/HightCharts/HightCharts.vue';
  ...
  export default {
    data() {
      return {
        ...
        iconClass:'icon-one-column2',//无数据图表样式
        countType: '1',
        goalId: '',
        dialogConfig: {    // 弹窗对话框
          show: false,
      ...
      getDetailInfo() {
        ...
        let option = {
          ...
          success: (result) => {
            ...
            this.goalDetail.series.forEach((item,index) => {
              item.data.forEach(i=>{
                if(i && i > 0){
...
.crm_goal_filter{
 ...
 .title_selectorList .list_item{
  ...
  .crm_goal_dataBoard .title .arrow::after{
    content: normal;
  }
