...
export default {
    ...
    methods: {
        ...
        showMsgFromSearchBox (keyWord, val) {
            // 如果现在名称，则跳转到客户列表
            if(val === 'clientList'){
                this.$router.push('/clientList/isread');
            }
        ...
        clickTreeItem (payload) {
            ...
            if(payload.parentId){
               ...
               this.$router.push({path:"ClientDetails/ClientContent",query:{id:payload.id,isClient:1,isManager:1}})
            }
        },
