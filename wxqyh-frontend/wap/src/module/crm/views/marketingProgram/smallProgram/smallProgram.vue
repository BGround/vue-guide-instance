<template>
  <div class="wrap qwui-wrap">
    ...
    <router-link v-if="!showOpenFlag" class="qwui-marketing_button qwui-marketing_allow" :to="{path:'/openAuthority',query:{wxUserId:userId}}" tag="div">
      <span class="qwui-allow_text">无使用权限 联系管理员开通</span>
