<template>
    <div class="wrap"
        ...
        <load-more class="loadmore_wrap"    
               ...
               >
            <span v-if="!hasMore&&listParam.page==1">暂未查到数据</span>
...
import {getPraiseList} from '../../api/getData.js';
...
export default {
    ...
    methods:{
        ...
        clearLoadFun(keyword){
            ...
            self.listParam={
                'page': 1,
                'searchValue.keyWord': keyword ? keyword : ''
            };
            self.pageConfig = {
                currPage: 0,
                maxPage: 0,
        ...
        getList(){
            ...
            self.loading = true;
            self.lock_roll=true;
            getPraiseList(self.id, self.listParam,(data)=>{
